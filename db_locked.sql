rem ********************************************************************
rem * Filename          : db_locked.sql - Version 1.0
...
col uname2 format a16 heading "Holding User"
col oname2 format a08 heading "OS User"
...
select substr(s1.username,1,10) uname1,
       substr(s1.osuser,1,8) oname1,
       w.sid ssid,
       decode(w.request,
