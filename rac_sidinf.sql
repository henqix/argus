rem ********************************************************************
rem * Filename          : rac_sidinf.sql - Version 1.0
rem * Author            : Henk Uiterwijk
rem * Original          : 20-mei-96
rem * Last Update       : 
rem * Update            : 
rem * Description       : Monitor Logon Information for sid for RAC
rem ********************************************************************
...
accept  instid char prompt 'LOGON Information for instid : '
accept  orasid char prompt 'LOGON Information for sid    : '

col instid format a2 heading 'Cn'
